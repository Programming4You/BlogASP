...
namespace BlogAsp.Controllers
{
    ...
    public class ManageController : Controller
    {
        ...
        public ActionResult AddUserImage(ApplicationUser user, HttpPostedFileBase image)
        {
            ...
            var userUserImage = database.AspNetUsers.Where(u => u.UserName == this.User.Identity.Name).First().UserImage;
            ...
            // Save article in DB
            database.AspNetUsers.Where(u => u.UserName == this.User.Identity.Name).First().UserImage = userUserImage;
